...
public class ProdutoDAO{
	...
	public String excluir(int codigo) {
		...
		try {
			...
			// n�mero um � para ser o primeiro parametro, da esquerda para a direita.
			// esse parametro 1 server como referencia do parametro l� em cima, do c�digo, ou seja,
			// esse parametro vai no lugar da interroga��o
